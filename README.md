...
pipeline configuration json file), this stage outputs the following files to `<data-root>/Outputs`:
 - Local copies of the messages, individuals, and production CSVs (`imaqal_s01_individuals.csv`, `imaqal_s01_messages.csv`, 
   `imaqal_s01_production.csv`)
